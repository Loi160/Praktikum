...
width: 300px; margin-top: 15px; border-radius: 5px;
}
...
<input type="text" id="nim" placeholder="Contoh: 120102" />
...
<div class="hasil-box">
<p><span class="label">Nama</span> : <span id="nama">-
</span></p>
<p><span class="label">Jurusan</span> : <span id="jurusan">-
</span></p>
<p><span class="label">Email</span> : <span id="email">-
</span></p>
</div>
...
$.ajax({
url: "get_data.php", type: "POST",
data: { nim: nim_cari }, dataType: "json", timeout: 5000,
...
complete: function(xhr, status) { console.log("Status pencarian AJAX: " + status);
}
});
